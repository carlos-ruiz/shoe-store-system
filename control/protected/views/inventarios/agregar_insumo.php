...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-body">
		<hr/>
		<div class="form-group <?php if($form->error($model,'id_insumos')!=''){ echo 'has-error'; }?>">
			<?php echo $form->labelEx($model,'id_insumos', array('class'=>'control-label')); ?>
			<div class="input-group">
				<?php echo $form->dropDownList($model,'id_insumos', $model->obtenerInsumos(), array('class' => 'form-control',"empty"=>"Seleccione una opci&oacute;n")); ?>
				<?php echo $form->error($model,'id_insumos', array('class'=>'help-block')); ?>
			</div>
		</div>
