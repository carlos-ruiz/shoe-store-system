...
/**
 * This is the model class for table "inventario_insumos".
 *
 * The followings are the available columns in table 'inventario_insumos':
 * @property integer $id
...
class InventarioInsumos extends CActiveRecord
{
	 ...
	 * @return InventarioInsumos the static model class
	 */
