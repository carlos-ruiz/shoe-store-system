...
class ModelosController extends Controller {
    ...
    public function actionAdmin() {
        ...
        $allModels = filter_input(INPUT_GET, 'Modelos');
//        foreach ($allModels as $model) {
//            $modelImage = $model->imagen;
//            $newImage = str_replace("/controlbom/control/", "",$modelImage);
//            $model->imagen = $newImage;
//            $model->save();
//        }
        if (isset($allModels)) {
            $model->attributes = $allModels;
        }
