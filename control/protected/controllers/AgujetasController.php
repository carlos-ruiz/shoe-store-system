...
class AgujetasController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('index', 'view', 'create', 'update', 'admin', 'delete', 'agregarInventario', 'descontarInventario'),
    ...
    public function actionCreate() {
        ...
        if (isset(filter_input(INPUT_POST, 'Agujetas'))) {
            $coloresSeleccionados = array();
            $agujetasColores = filter_input(INPUT_POST, 'AgujetasColores');
            $coloresIds = $agujetasColores['id_colores'];
            if (isset($agujetasColores) && isset($coloresIds)) {
                $coloresSeleccionados = $coloresIds;
            }

            $model->attributes = filter_input(INPUT_POST, 'Agujetas');
